...
const BooksPage = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', padding: '40px 20px', color: '#fff' }}>
      {/* Fondo GridMotion */}
      <div
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', width: '100%', maxWidth: '800px', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
