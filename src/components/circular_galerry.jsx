...
import '../compCSS/circular_galery.css';
...
class App {
  ...
  createMedias(items, bend = 0, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      { id: 3, image: `https://picsum.photos/seed/3/800/600?grayscale`, text: 'Waterfall' },
      { id: 4, image: `https://picsum.photos/seed/4/800/600?grayscale`, text: 'Strawberries' },
      { id: 5, image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'Deep Diving' },
      { id: 6, image: `https://picsum.photos/seed/16/800/600?grayscale`, text: 'Train Track' },
      { id: 7, image: `https://picsum.photos/seed/17/800/600?grayscale`, text: 'Santorini' },
      { id: 8, image: `https://picsum.photos/seed/8/800/600?grayscale`, text: 'Blurry Lights' },
      { id: 9, image: `https://picsum.photos/seed/9/800/600?grayscale`, text: 'New York' },
      { id: 10, image: `https://picsum.photos/seed/10/800/600?grayscale`, text: 'Good Boy' },
      { id: 11, image: `https://picsum.photos/seed/21/800/600?grayscale`, text: 'Coastline' },
      { id: 12, image: `https://picsum.photos/seed/12/800/600?grayscale`, text: 'Palm Trees' }
    ];
...
export default function CircularGallery({
  ...
  useEffect(() => {
    const app = new App(containerRef.current, {
        ...
        scrollEase,
        onItemClick: (item) => {
            console.log("Clickeaste en:", item.text);
            // Navegar a la página de detalle usando el ID del item
            // Asegúrate de que tus items tengan un ID
            if (item.id) {
